...
const DAILY_RECOGNIZE_TARGET = STUDY_CONFIG.dailyTargets.recognize;
const DAILY_LISTEN_TARGET = STUDY_CONFIG.dailyTargets.listen;
const DAILY_SPELL_TARGET = STUDY_CONFIG.dailyTargets.spell;
const DAILY_MODE_SEQUENCE = STUDY_CONFIG.afterTargetSequence;
const WRONG_PARK_DAYS = STUDY_CONFIG.wrongParkDays;
const DAILY_WRONG_RETRY_LIMITS = STUDY_CONFIG.dailyWrongRetryLimits;
