...
const DISTRACTOR_GROUPS = [
  ...
  ["grandfather", "grandmother", "grandparent", "grandad", "granddad"],
  ["head", "face", "eye", "ear", "nose", "mouth", "tooth", "hand", "arm", "leg", "foot"],
  ["shirt", "t-shirt", "coat", "jacket", "dress", "skirt", "shoe", "sock", "hat", "trousers"],
  ["bus", "car", "train", "taxi", "boat", "ship", "bike", "bicycle", "aeroplane", "airplane"],
  ["school", "library", "bank", "hospital", "hotel", "museum", "park", "cinema", "restaurant"],
...
function createStore() {
  ...
  function getDistractorPool(wordId, limit = 16) {
    ...
    return getAllStates()
      ...
      .sort((left, right) => {
        const leftGroupScore = isInDistractorGroup(left, candidateGroupTerms) ? 1 : 0;
        const rightGroupScore = isInDistractorGroup(right, candidateGroupTerms) ? 1 : 0;
        ...
        return (
          rightGroupScore - leftGroupScore ||
